...
void creer_IPC(int argv1, int argv2){
    ...
    char * argv_journal[] = {"journaliste",NULL,NULL,NULL, NULL, NULL, NULL};
    char * argv_archiv[] = {"archiviste",NULL,NULL,NULL};
    char arg1[50]; char arg2[50]; char arg4[50]; char arg5[50];
    ...
    for(int j = 0; j<argv2;j++){
      ...
      if (tab==(int *) -1){
        ...
        delete_smp(NB_ARTICLE,nb_theme);
        exit(-1);
    }
